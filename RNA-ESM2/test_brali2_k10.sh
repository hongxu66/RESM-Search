...
filepath=/mnt/hdd/xhong/PostWork/2023/BPmap-LM/BRAliBASE2.1/k10/
...
do
	...
	python esm_profile_test_batch.py produce.seqfile=$j produce.outname=k10_${i}_${j##*/}
	# echo python esm_profile_test_batch.py produce.seqfile=$j produce.outname=k10_${i}_${j##*/}
    done
done
