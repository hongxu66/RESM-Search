...
def produce_seqprf(cfg: Config) -> None:
    def readfasta1(filename):
        ...
        for item in tem:
            seqs.append((str(item.id),str(item.seq).replace('N','')))
        return seqs
    ...
    # seqs = readfasta1('/lustre/home/xhong/PostDotWorks/2023/yikun/RNA-ESM2/allseqs.fasta')
    # seqs = readfasta1('/lustre/home/xhong/PostDotWorks/2023/PDBSS/fasta/output.fasta')
    # seqs = readfasta1('/lustre/home/xhong/PostDotWorks/2023/yikun/RNA-ESM2/testZhou.fasta')
    # seqs = readfasta1('/lustre/home/xhong/PostDotWorks/2023/yikun/RNA-ESM2/All_IRES.fa')
    # seqs = readfasta1('/lustre/home/xhong/PostDotWorks/2023/yikun/RNA-ESM2/PDB_IRES.fasta')
    # seqs = readfasta1('/lustre/home/xhong/PostDotWorks/2023/yikun/RNA-ESM2/allseqs.fasta')
    ...
    # seqs = readfasta1('/lustre/home/xhong/PostDotWorks/2023/xrRNA_LM/5tpy.fa')
    # seqs = readfasta1('/lustre/home/xhong/PostDotWorks/2023/BPmap_new_training/RNAstrAlign/src1/RMalign_all_seq.fa')
    # seqs = readfasta1('/lustre/home/xhong/PostDotWorks/2023/BPmap_new_training/RNAstrAlign/MAP1/RMalign_all_seq.fa')
    # seqs = readfasta1('/lustre/home/xhong/PostDotWorks/2023/BPmap_new_training/RNAstrAlign/src1/allpdb_0.99_15_500.fasta')
...
#            outfea = normalize(outfea,axis=1,norm='l1')
    ...
    np.savez('./RNAcmap3_features.npz',a=datas)
    # np.savez('./attentions.npz',a=attens)
    np.savez('./RNAcmap3_contacts.npz',a=conts)
