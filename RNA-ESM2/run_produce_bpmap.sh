...
dirpath=/mnt/remote_home/xhong/PostWork/2025/latest_pos/chr1
...
do
    ...
    if [ ! -f /mnt/remote_home/xhong/PostWork/2024/RNA-ESM2/results_650_con/chr1_${id}_allmaps.bpmap ];
    then
        CUDA_VISIBLE_DEVICES=1 python esm2embatt_650M_con.py produce.seqfile=${seqfile} produce.outname=chr1_${id}
    fi
done
